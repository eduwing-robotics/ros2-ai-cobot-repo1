...
```bash
python3 /home/juchan-yoon/FR5_robot_control/vision_assembly/tools/extract_unity_board_layout.py \
...
```bash
/home/juchan-yoon/FR5_robot_control/vision_assembly/run_board_pose_dry_run.sh --frames 20
```
...
```bash
/home/juchan-yoon/FR5_robot_control/vision_assembly/run_board_view.sh
```
