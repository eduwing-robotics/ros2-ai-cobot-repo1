...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_fairino_msgs
max_serialized_size_key_RemoteScriptContent_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_fairino_msgs
max_serialized_size_key_RemoteScriptContent_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
// functions for fairino_msgs::srv::RemoteScriptContent_Request already declared above

// functions for fairino_msgs::srv::RemoteScriptContent_Response already declared above
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_fairino_msgs
cdr_serialize(
  const fairino_msgs::srv::RemoteScriptContent_Event & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: info
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  fairino_msgs::srv::RemoteScriptContent_Event & ros_message)
{
  // Member: info
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_fairino_msgs
max_serialized_size_RemoteScriptContent_Event(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // Member: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        fairino_msgs::srv::typesupport_fastrtps_cpp::max_serialized_size_RemoteScriptContent_Request(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Member: response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        fairino_msgs::srv::typesupport_fastrtps_cpp::max_serialized_size_RemoteScriptContent_Response(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = fairino_msgs::srv::RemoteScriptContent_Event;
    is_plain =
      (
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_fairino_msgs
max_serialized_size_key_RemoteScriptContent_Event(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // Member: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        fairino_msgs::srv::typesupport_fastrtps_cpp::max_serialized_size_key_RemoteScriptContent_Request(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Member: response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        fairino_msgs::srv::typesupport_fastrtps_cpp::max_serialized_size_key_RemoteScriptContent_Response(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
...
{
  auto typed_message =
    static_cast<const fairino_msgs::srv::RemoteScriptContent_Event *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<fairino_msgs::srv::RemoteScriptContent_Event *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _RemoteScriptContent_Event__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const fairino_msgs::srv::RemoteScriptContent_Event *>(
...
static size_t _RemoteScriptContent_Event__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_RemoteScriptContent_Event(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _RemoteScriptContent_Event__callbacks = {
  "fairino_msgs::srv",
...
static rosidl_message_type_support_t _RemoteScriptContent_Event__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_RemoteScriptContent_Event__callbacks,
  get_message_typesupport_handle_function,
...
{
  return &fairino_msgs::srv::typesupport_fastrtps_cpp::_RemoteScriptContent_Event__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, fairino_msgs, srv, RemoteScriptContent_Event)() {
  return &fairino_msgs::srv::typesupport_fastrtps_cpp::_RemoteScriptContent_Event__handle;
}
...
static const rosidl_service_type_support_t _RemoteScriptContent__handle{
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_RemoteScriptContent__callbacks,
  get_service_typesupport_handle_function,
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<fairino_msgs::srv::RemoteScriptContent_Request>(),
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<fairino_msgs::srv::RemoteScriptContent_Response>(),
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<fairino_msgs::srv::RemoteScriptContent_Event>(),
