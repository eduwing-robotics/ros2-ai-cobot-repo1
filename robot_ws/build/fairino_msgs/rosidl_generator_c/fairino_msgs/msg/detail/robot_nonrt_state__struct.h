...
typedef struct fairino_msgs__msg__RobotNonrtState
{
  ...
  double exaxispos1;
  int32_t exaxistatus1[10];
  double exaxispos2;
  int32_t exaxistatus2[10];
  double exaxispos3;
  int32_t exaxistatus3[10];
  double exaxispos4;
  int32_t exaxistatus4[10];
  double ft_fx_data;
  double ft_fy_data;
  double ft_fz_data;
  double ft_tx_data;
  ...
  uint8_t auxservoservoid;
  int32_t auxservoerrcode;
  int32_t auxservostate;
  double auxservoactualpos;
  double auxservoctualspeed;
  double auxservoactualtorque;
  uint16_t extpioinput[8];
  uint16_t extpiooutput[8];
  uint16_t extadcinput[4];
  uint16_t extadcoutput[4];
  uint8_t reconnect_flag;
  uint8_t exaxiscoordid;
  double slave_status_1;
  double slave_status_2;
  int32_t slave_domain_id;
  uint8_t program_run_state;
  double speed_scale_manual;
  double speed_scale_auto;
