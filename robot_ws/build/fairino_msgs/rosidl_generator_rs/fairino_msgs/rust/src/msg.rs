...
pub struct RobotNonrtState {
    ...
    // This member is not documented.
    #[allow(missing_docs)]
    pub auxservoservoid: u8,


    // This member is not documented.
    #[allow(missing_docs)]
    pub auxservoerrcode: i32,


    // This member is not documented.
    #[allow(missing_docs)]
    pub auxservostate: i32,


    // This member is not documented.
    #[allow(missing_docs)]
    pub auxservoactualpos: f64,


    // This member is not documented.
    #[allow(missing_docs)]
    pub auxservoctualspeed: f64,


    // This member is not documented.
    #[allow(missing_docs)]
    pub auxservoactualtorque: f64,


    // This member is not documented.
    #[allow(missing_docs)]
    pub extpioinput: [u16; 8],


    // This member is not documented.
    #[allow(missing_docs)]
    pub extpiooutput: [u16; 8],


    // This member is not documented.
    #[allow(missing_docs)]
    pub extadcinput: [u16; 4],


    // This member is not documented.
    #[allow(missing_docs)]
    pub extadcoutput: [u16; 4],


    // This member is not documented.
    #[allow(missing_docs)]
    pub reconnect_flag: u8,


    // This member is not documented.
    #[allow(missing_docs)]
    pub exaxiscoordid: u8,


    // This member is not documented.
    #[allow(missing_docs)]
    pub slave_status_1: f64,


    // This member is not documented.
    #[allow(missing_docs)]
    pub slave_status_2: f64,


    // This member is not documented.
    #[allow(missing_docs)]
    pub slave_domain_id: i32,


    // This member is not documented.
    #[allow(missing_docs)]
    pub program_run_state: u8,


    // This member is not documented.
    #[allow(missing_docs)]
    pub speed_scale_manual: f64,


    // This member is not documented.
    #[allow(missing_docs)]
    pub speed_scale_auto: f64,
  ...
  fn into_rmw_message(msg_cow: std::borrow::Cow<'_, Self>) -> std::borrow::Cow<'_, Self::RmwMsg> {
    match msg_cow {
      std::borrow::Cow::Owned(msg) => std::borrow::Cow::Owned(Self::RmwMsg {
        ...
        exaxistatus1: msg.exaxistatus1,
        exaxispos2: msg.exaxispos2,
        exaxistatus2: msg.exaxistatus2,
        exaxispos3: msg.exaxispos3,
        exaxistatus3: msg.exaxistatus3,
        exaxispos4: msg.exaxispos4,
        exaxistatus4: msg.exaxistatus4,
        ...
        auxservoservoid: msg.auxservoservoid,
        auxservoerrcode: msg.auxservoerrcode,
        auxservostate: msg.auxservostate,
        auxservoactualpos: msg.auxservoactualpos,
        auxservoctualspeed: msg.auxservoctualspeed,
        auxservoactualtorque: msg.auxservoactualtorque,
        extpioinput: msg.extpioinput,
        extpiooutput: msg.extpiooutput,
        extadcinput: msg.extadcinput,
        extadcoutput: msg.extadcoutput,
        reconnect_flag: msg.reconnect_flag,
        exaxiscoordid: msg.exaxiscoordid,
        slave_status_1: msg.slave_status_1,
        slave_status_2: msg.slave_status_2,
        slave_domain_id: msg.slave_domain_id,
        program_run_state: msg.program_run_state,
        speed_scale_manual: msg.speed_scale_manual,
        speed_scale_auto: msg.speed_scale_auto,
      }),
