...
class Metaclass_RemoteCmdInterface_Event(type):
    """Metaclass of message 'RemoteCmdInterface_Event'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__srv__remote_cmd_interface__event
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__srv__remote_cmd_interface__event
            cls._CONVERT_TO_PY = module.convert_to_py_msg__srv__remote_cmd_interface__event
            cls._TYPE_SUPPORT = module.type_support_msg__srv__remote_cmd_interface__event
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__srv__remote_cmd_interface__event
...
class RemoteCmdInterface_Event(metaclass=Metaclass_RemoteCmdInterface_Event):
    """Message class 'RemoteCmdInterface_Event'."""
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<fairino_msgs/RemoteCmdInterface_Request, 1>',
        'response': 'sequence<fairino_msgs/RemoteCmdInterface_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['fairino_msgs', 'srv'], 'RemoteCmdInterface_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['fairino_msgs', 'srv'], 'RemoteCmdInterface_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from fairino_msgs.srv import RemoteCmdInterface_Request
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 len(value) <= 1 and
                 all(isinstance(v, RemoteCmdInterface_Request) for v in value) and
                 True), \
                "The 'request' field must be a set or sequence with length <= 1 and each value of type 'RemoteCmdInterface_Request'"
        self._request = value
    ...
    def response(self, value):
        if self._check_fields:
            from fairino_msgs.srv import RemoteCmdInterface_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, RemoteCmdInterface_Response) for v in value) and
                 True), \
                "The 'response' field must be a set or sequence with length <= 1 and each value of type 'RemoteCmdInterface_Response'"
...
class Metaclass_RemoteCmdInterface(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            if _remote_cmd_interface.Metaclass_RemoteCmdInterface_Event._TYPE_SUPPORT is None:
                _remote_cmd_interface.Metaclass_RemoteCmdInterface_Event.__import_type_support__()
...
class RemoteCmdInterface(metaclass=Metaclass_RemoteCmdInterface):
    ...
    from fairino_msgs.srv._remote_cmd_interface import RemoteCmdInterface_Event as Event
