...
bool fairino_msgs__msg__robot_nonrt_state__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  ...
  {  // exaxistatus1
    PyObject * field = PyObject_GetAttrString(_pymsg, "exaxistatus1");
    if (!field) {
      return false;
    }
    {
      ...
      Py_ssize_t size = 10;
      int32_t * dest = ros_message->exaxistatus1;
  ...
  {  // exaxistatus2
    PyObject * field = PyObject_GetAttrString(_pymsg, "exaxistatus2");
    if (!field) {
      return false;
    }
    {
      ...
      assert(PyArray_TYPE(seq_field) == NPY_INT32);
      Py_ssize_t size = 10;
      int32_t * dest = ros_message->exaxistatus2;
      for (Py_ssize_t i = 0; i < size; ++i) {
        int32_t tmp = *(npy_int32 *)PyArray_GETPTR1(seq_field, i);
        memcpy(&dest[i], &tmp, sizeof(int32_t));
      }
  ...
  {  // exaxistatus3
    PyObject * field = PyObject_GetAttrString(_pymsg, "exaxistatus3");
    if (!field) {
      return false;
    }
    {
      ...
      assert(PyArray_TYPE(seq_field) == NPY_INT32);
      Py_ssize_t size = 10;
      int32_t * dest = ros_message->exaxistatus3;
      for (Py_ssize_t i = 0; i < size; ++i) {
        int32_t tmp = *(npy_int32 *)PyArray_GETPTR1(seq_field, i);
        memcpy(&dest[i], &tmp, sizeof(int32_t));
      }
  ...
  {  // exaxistatus4
    PyObject * field = PyObject_GetAttrString(_pymsg, "exaxistatus4");
    if (!field) {
      return false;
    }
    {
      ...
      assert(PyArray_TYPE(seq_field) == NPY_INT32);
      Py_ssize_t size = 10;
      int32_t * dest = ros_message->exaxistatus4;
      for (Py_ssize_t i = 0; i < size; ++i) {
        int32_t tmp = *(npy_int32 *)PyArray_GETPTR1(seq_field, i);
        memcpy(&dest[i], &tmp, sizeof(int32_t));
      }
  ...
  {  // auxservoservoid
    PyObject * field = PyObject_GetAttrString(_pymsg, "auxservoservoid");
    if (!field) {
      return false;
    }
    assert(PyLong_Check(field));
    ros_message->auxservoservoid = (uint8_t)PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
  {  // auxservoerrcode
    PyObject * field = PyObject_GetAttrString(_pymsg, "auxservoerrcode");
    if (!field) {
      return false;
    }
    assert(PyLong_Check(field));
    ros_message->auxservoerrcode = (int32_t)PyLong_AsLong(field);
    Py_DECREF(field);
  }
  {  // auxservostate
    PyObject * field = PyObject_GetAttrString(_pymsg, "auxservostate");
    if (!field) {
      return false;
    }
    assert(PyLong_Check(field));
    ros_message->auxservostate = (int32_t)PyLong_AsLong(field);
    Py_DECREF(field);
  }
  {  // auxservoactualpos
    PyObject * field = PyObject_GetAttrString(_pymsg, "auxservoactualpos");
    if (!field) {
      return false;
    }
    assert(PyFloat_Check(field));
    ros_message->auxservoactualpos = PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
  {  // auxservoctualspeed
    PyObject * field = PyObject_GetAttrString(_pymsg, "auxservoctualspeed");
    if (!field) {
      return false;
    }
    assert(PyFloat_Check(field));
    ros_message->auxservoctualspeed = PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
  {  // auxservoactualtorque
    PyObject * field = PyObject_GetAttrString(_pymsg, "auxservoactualtorque");
    if (!field) {
      return false;
    }
    assert(PyFloat_Check(field));
    ros_message->auxservoactualtorque = PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
  {  // extpioinput
    PyObject * field = PyObject_GetAttrString(_pymsg, "extpioinput");
    if (!field) {
      return false;
    }
    {
      ...
      Py_ssize_t size = 8;
      uint16_t * dest = ros_message->extpioinput;
      for (Py_ssize_t i = 0; i < size; ++i) {
  ...
  {  // extpiooutput
    PyObject * field = PyObject_GetAttrString(_pymsg, "extpiooutput");
    if (!field) {
      return false;
    }
    {
      ...
      assert(PyArray_TYPE(seq_field) == NPY_UINT16);
      Py_ssize_t size = 8;
      uint16_t * dest = ros_message->extpiooutput;
      for (Py_ssize_t i = 0; i < size; ++i) {
        uint16_t tmp = *(npy_uint16 *)PyArray_GETPTR1(seq_field, i);
        memcpy(&dest[i], &tmp, sizeof(uint16_t));
      }
  ...
  {  // extadcinput
    PyObject * field = PyObject_GetAttrString(_pymsg, "extadcinput");
    if (!field) {
      return false;
    }
    {
      ...
      assert(PyArray_TYPE(seq_field) == NPY_UINT16);
      Py_ssize_t size = 4;
      uint16_t * dest = ros_message->extadcinput;
      for (Py_ssize_t i = 0; i < size; ++i) {
        uint16_t tmp = *(npy_uint16 *)PyArray_GETPTR1(seq_field, i);
        memcpy(&dest[i], &tmp, sizeof(uint16_t));
      }
  ...
  {  // extadcoutput
    PyObject * field = PyObject_GetAttrString(_pymsg, "extadcoutput");
    if (!field) {
      return false;
    }
    {
      ...
      assert(PyArray_TYPE(seq_field) == NPY_UINT16);
      Py_ssize_t size = 4;
      uint16_t * dest = ros_message->extadcoutput;
      for (Py_ssize_t i = 0; i < size; ++i) {
        uint16_t tmp = *(npy_uint16 *)PyArray_GETPTR1(seq_field, i);
        memcpy(&dest[i], &tmp, sizeof(uint16_t));
      }
  ...
  {  // reconnect_flag
    PyObject * field = PyObject_GetAttrString(_pymsg, "reconnect_flag");
    if (!field) {
      return false;
    }
    assert(PyLong_Check(field));
    ros_message->reconnect_flag = (uint8_t)PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
  {  // exaxiscoordid
    PyObject * field = PyObject_GetAttrString(_pymsg, "exaxiscoordid");
    if (!field) {
      return false;
    }
    assert(PyLong_Check(field));
    ros_message->exaxiscoordid = (uint8_t)PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
  {  // slave_status_1
    PyObject * field = PyObject_GetAttrString(_pymsg, "slave_status_1");
    if (!field) {
      return false;
    }
    assert(PyFloat_Check(field));
    ros_message->slave_status_1 = PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
  {  // slave_status_2
    PyObject * field = PyObject_GetAttrString(_pymsg, "slave_status_2");
    if (!field) {
      return false;
    }
    assert(PyFloat_Check(field));
    ros_message->slave_status_2 = PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
  {  // slave_domain_id
    PyObject * field = PyObject_GetAttrString(_pymsg, "slave_domain_id");
    if (!field) {
      return false;
    }
    assert(PyLong_Check(field));
    ros_message->slave_domain_id = (int32_t)PyLong_AsLong(field);
    Py_DECREF(field);
  }
  {  // program_run_state
    PyObject * field = PyObject_GetAttrString(_pymsg, "program_run_state");
    if (!field) {
      return false;
    }
    assert(PyLong_Check(field));
    ros_message->program_run_state = (uint8_t)PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
  {  // speed_scale_manual
    PyObject * field = PyObject_GetAttrString(_pymsg, "speed_scale_manual");
    if (!field) {
      return false;
    }
    assert(PyFloat_Check(field));
    ros_message->speed_scale_manual = PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
  {  // speed_scale_auto
    PyObject * field = PyObject_GetAttrString(_pymsg, "speed_scale_auto");
    if (!field) {
      return false;
    }
    assert(PyFloat_Check(field));
    ros_message->speed_scale_auto = PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
...
PyObject * fairino_msgs__msg__robot_nonrt_state__convert_to_py(void * raw_ros_message)
{
  ...
  {  // exaxistatus1
    PyObject * field = NULL;
    field = PyObject_GetAttrString(_pymessage, "exaxistatus1");
    if (!field) {
      return NULL;
    }
    assert(field->ob_type != NULL);
    ...
    int32_t * src = &(ros_message->exaxistatus1[0]);
  ...
  {  // exaxistatus2
    PyObject * field = NULL;
    field = PyObject_GetAttrString(_pymessage, "exaxistatus2");
    if (!field) {
      return NULL;
    }
    assert(field->ob_type != NULL);
    ...
    assert(sizeof(npy_int32) == sizeof(int32_t));
    npy_int32 * dst = (npy_int32 *)PyArray_GETPTR1(seq_field, 0);
    int32_t * src = &(ros_message->exaxistatus2[0]);
    memcpy(dst, src, 10 * sizeof(int32_t));
    Py_DECREF(field);
  }
  {  // exaxispos3
  ...
  {  // exaxistatus3
    PyObject * field = NULL;
    field = PyObject_GetAttrString(_pymessage, "exaxistatus3");
    if (!field) {
      return NULL;
    }
    assert(field->ob_type != NULL);
    ...
    assert(sizeof(npy_int32) == sizeof(int32_t));
    npy_int32 * dst = (npy_int32 *)PyArray_GETPTR1(seq_field, 0);
    int32_t * src = &(ros_message->exaxistatus3[0]);
    memcpy(dst, src, 10 * sizeof(int32_t));
    Py_DECREF(field);
  }
  {  // exaxispos4
  ...
  {  // exaxistatus4
    PyObject * field = NULL;
    field = PyObject_GetAttrString(_pymessage, "exaxistatus4");
    if (!field) {
      return NULL;
    }
    assert(field->ob_type != NULL);
    ...
    assert(sizeof(npy_int32) == sizeof(int32_t));
    npy_int32 * dst = (npy_int32 *)PyArray_GETPTR1(seq_field, 0);
    int32_t * src = &(ros_message->exaxistatus4[0]);
    memcpy(dst, src, 10 * sizeof(int32_t));
    Py_DECREF(field);
  }
  {  // ft_fx_data
  ...
  {  // auxservoservoid
    PyObject * field = NULL;
    field = PyLong_FromUnsignedLong(ros_message->auxservoservoid);
    {
      int rc = PyObject_SetAttrString(_pymessage, "auxservoservoid", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // auxservoerrcode
    PyObject * field = NULL;
    field = PyLong_FromLong(ros_message->auxservoerrcode);
    {
      int rc = PyObject_SetAttrString(_pymessage, "auxservoerrcode", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // auxservostate
    PyObject * field = NULL;
    field = PyLong_FromLong(ros_message->auxservostate);
    {
      int rc = PyObject_SetAttrString(_pymessage, "auxservostate", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // auxservoactualpos
    PyObject * field = NULL;
    field = PyFloat_FromDouble(ros_message->auxservoactualpos);
    {
      int rc = PyObject_SetAttrString(_pymessage, "auxservoactualpos", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // auxservoctualspeed
    PyObject * field = NULL;
    field = PyFloat_FromDouble(ros_message->auxservoctualspeed);
    {
      int rc = PyObject_SetAttrString(_pymessage, "auxservoctualspeed", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // auxservoactualtorque
    PyObject * field = NULL;
    field = PyFloat_FromDouble(ros_message->auxservoactualtorque);
    {
      int rc = PyObject_SetAttrString(_pymessage, "auxservoactualtorque", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // extpioinput
    PyObject * field = NULL;
    field = PyObject_GetAttrString(_pymessage, "extpioinput");
    if (!field) {
      return NULL;
    }
    assert(field->ob_type != NULL);
    ...
    uint16_t * src = &(ros_message->extpioinput[0]);
    memcpy(dst, src, 8 * sizeof(uint16_t));
    Py_DECREF(field);
  }
  {  // extpiooutput
    PyObject * field = NULL;
    field = PyObject_GetAttrString(_pymessage, "extpiooutput");
    if (!field) {
      return NULL;
    }
    assert(field->ob_type != NULL);
    ...
    assert(sizeof(npy_uint16) == sizeof(uint16_t));
    npy_uint16 * dst = (npy_uint16 *)PyArray_GETPTR1(seq_field, 0);
    uint16_t * src = &(ros_message->extpiooutput[0]);
    memcpy(dst, src, 8 * sizeof(uint16_t));
    Py_DECREF(field);
  }
  {  // extadcinput
    PyObject * field = NULL;
    field = PyObject_GetAttrString(_pymessage, "extadcinput");
    if (!field) {
      return NULL;
    }
    assert(field->ob_type != NULL);
    ...
    assert(sizeof(npy_uint16) == sizeof(uint16_t));
    npy_uint16 * dst = (npy_uint16 *)PyArray_GETPTR1(seq_field, 0);
    uint16_t * src = &(ros_message->extadcinput[0]);
    memcpy(dst, src, 4 * sizeof(uint16_t));
    Py_DECREF(field);
  }
  {  // extadcoutput
    PyObject * field = NULL;
    field = PyObject_GetAttrString(_pymessage, "extadcoutput");
    if (!field) {
      return NULL;
    }
    assert(field->ob_type != NULL);
    ...
    assert(sizeof(npy_uint16) == sizeof(uint16_t));
    npy_uint16 * dst = (npy_uint16 *)PyArray_GETPTR1(seq_field, 0);
    uint16_t * src = &(ros_message->extadcoutput[0]);
    memcpy(dst, src, 4 * sizeof(uint16_t));
    Py_DECREF(field);
  }
  {  // reconnect_flag
    PyObject * field = NULL;
    field = PyLong_FromUnsignedLong(ros_message->reconnect_flag);
    {
      int rc = PyObject_SetAttrString(_pymessage, "reconnect_flag", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // exaxiscoordid
    PyObject * field = NULL;
    field = PyLong_FromUnsignedLong(ros_message->exaxiscoordid);
    {
      int rc = PyObject_SetAttrString(_pymessage, "exaxiscoordid", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // slave_status_1
    PyObject * field = NULL;
    field = PyFloat_FromDouble(ros_message->slave_status_1);
    {
      int rc = PyObject_SetAttrString(_pymessage, "slave_status_1", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // slave_status_2
    PyObject * field = NULL;
    field = PyFloat_FromDouble(ros_message->slave_status_2);
    {
      int rc = PyObject_SetAttrString(_pymessage, "slave_status_2", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // slave_domain_id
    PyObject * field = NULL;
    field = PyLong_FromLong(ros_message->slave_domain_id);
    {
      int rc = PyObject_SetAttrString(_pymessage, "slave_domain_id", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // program_run_state
    PyObject * field = NULL;
    field = PyLong_FromUnsignedLong(ros_message->program_run_state);
    {
      int rc = PyObject_SetAttrString(_pymessage, "program_run_state", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // speed_scale_manual
    PyObject * field = NULL;
    field = PyFloat_FromDouble(ros_message->speed_scale_manual);
    {
      int rc = PyObject_SetAttrString(_pymessage, "speed_scale_manual", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // speed_scale_auto
    PyObject * field = NULL;
    field = PyFloat_FromDouble(ros_message->speed_scale_auto);
    {
      int rc = PyObject_SetAttrString(_pymessage, "speed_scale_auto", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
