...
struct RobotNonrtState_
{
  ...
  explicit RobotNonrtState_(rosidl_runtime_cpp::MessageInitialization _init = rosidl_runtime_cpp::MessageInitialization::ALL)
  {
      ...
      rosidl_runtime_cpp::MessageInitialization::ZERO == _init)
    {
      ...
      this->exaxispos1 = 0.0;
      std::fill<typename std::array<int32_t, 10>::iterator, int32_t>(this->exaxistatus1.begin(), this->exaxistatus1.end(), 0l);
      this->exaxispos2 = 0.0;
      std::fill<typename std::array<int32_t, 10>::iterator, int32_t>(this->exaxistatus2.begin(), this->exaxistatus2.end(), 0l);
      this->exaxispos3 = 0.0;
      std::fill<typename std::array<int32_t, 10>::iterator, int32_t>(this->exaxistatus3.begin(), this->exaxistatus3.end(), 0l);
      this->exaxispos4 = 0.0;
      std::fill<typename std::array<int32_t, 10>::iterator, int32_t>(this->exaxistatus4.begin(), this->exaxistatus4.end(), 0l);
      this->ft_fx_data = 0.0;
      this->ft_fy_data = 0.0;
      this->ft_fz_data = 0.0;
      this->ft_tx_data = 0.0;
      ...
      this->auxservoerrcode = 0l;
      this->auxservostate = 0l;
      this->auxservoactualpos = 0.0;
      this->auxservoctualspeed = 0.0;
      this->auxservoactualtorque = 0.0;
      std::fill<typename std::array<uint16_t, 8>::iterator, uint16_t>(this->extpioinput.begin(), this->extpioinput.end(), 0);
      std::fill<typename std::array<uint16_t, 8>::iterator, uint16_t>(this->extpiooutput.begin(), this->extpiooutput.end(), 0);
      std::fill<typename std::array<uint16_t, 4>::iterator, uint16_t>(this->extadcinput.begin(), this->extadcinput.end(), 0);
      std::fill<typename std::array<uint16_t, 4>::iterator, uint16_t>(this->extadcoutput.begin(), this->extadcoutput.end(), 0);
      this->reconnect_flag = 0;
      this->exaxiscoordid = 0;
      this->slave_status_1 = 0.0;
      this->slave_status_2 = 0.0;
      this->slave_domain_id = 0l;
  ...
  using _exaxistatus1_type =
    std::array<int32_t, 10>;
  _exaxistatus1_type exaxistatus1;
  using _exaxispos2_type =
    double;
  _exaxispos2_type exaxispos2;
  using _exaxistatus2_type =
    std::array<int32_t, 10>;
  _exaxistatus2_type exaxistatus2;
  using _exaxispos3_type =
    double;
  _exaxispos3_type exaxispos3;
  using _exaxistatus3_type =
    std::array<int32_t, 10>;
  _exaxistatus3_type exaxistatus3;
  using _exaxispos4_type =
    double;
  _exaxispos4_type exaxispos4;
  using _exaxistatus4_type =
    std::array<int32_t, 10>;
  _exaxistatus4_type exaxistatus4;
  ...
  using _auxservoservoid_type =
    uint8_t;
  _auxservoservoid_type auxservoservoid;
  using _auxservoerrcode_type =
    int32_t;
  _auxservoerrcode_type auxservoerrcode;
  using _auxservostate_type =
    int32_t;
  _auxservostate_type auxservostate;
  using _auxservoactualpos_type =
    double;
  _auxservoactualpos_type auxservoactualpos;
  using _auxservoctualspeed_type =
    double;
  _auxservoctualspeed_type auxservoctualspeed;
  using _auxservoactualtorque_type =
    double;
  _auxservoactualtorque_type auxservoactualtorque;
  using _extpioinput_type =
    std::array<uint16_t, 8>;
  _extpioinput_type extpioinput;
  using _extpiooutput_type =
    std::array<uint16_t, 8>;
  _extpiooutput_type extpiooutput;
  using _extadcinput_type =
    std::array<uint16_t, 4>;
  _extadcinput_type extadcinput;
  using _extadcoutput_type =
    std::array<uint16_t, 4>;
  _extadcoutput_type extadcoutput;
  using _reconnect_flag_type =
    uint8_t;
  _reconnect_flag_type reconnect_flag;
  using _exaxiscoordid_type =
    uint8_t;
  _exaxiscoordid_type exaxiscoordid;
  using _slave_status_1_type =
    double;
  _slave_status_1_type slave_status_1;
  using _slave_status_2_type =
    double;
  _slave_status_2_type slave_status_2;
  using _slave_domain_id_type =
    int32_t;
  _slave_domain_id_type slave_domain_id;
  using _program_run_state_type =
    uint8_t;
  _program_run_state_type program_run_state;
  using _speed_scale_manual_type =
    double;
  _speed_scale_manual_type speed_scale_manual;
  using _speed_scale_auto_type =
    double;
  _speed_scale_auto_type speed_scale_auto;
  ...
  Type & set__exaxistatus1(
    const std::array<int32_t, 10> & _arg)
  {
    this->exaxistatus1 = _arg;
    return *this;
  }
  ...
  Type & set__exaxistatus2(
    const std::array<int32_t, 10> & _arg)
  {
    this->exaxistatus2 = _arg;
    return *this;
  }
  ...
  Type & set__exaxistatus3(
    const std::array<int32_t, 10> & _arg)
  {
    this->exaxistatus3 = _arg;
    return *this;
  }
  ...
  Type & set__exaxistatus4(
    const std::array<int32_t, 10> & _arg)
  {
    this->exaxistatus4 = _arg;
    return *this;
  }
  ...
  Type & set__auxservoservoid(
    const uint8_t & _arg)
  {
    this->auxservoservoid = _arg;
    return *this;
  }
  Type & set__auxservoerrcode(
    const int32_t & _arg)
  {
    this->auxservoerrcode = _arg;
    return *this;
  }
  Type & set__auxservostate(
    const int32_t & _arg)
  {
    this->auxservostate = _arg;
    return *this;
  }
  Type & set__auxservoactualpos(
    const double & _arg)
  {
    this->auxservoactualpos = _arg;
    return *this;
  }
  Type & set__auxservoctualspeed(
    const double & _arg)
  {
    this->auxservoctualspeed = _arg;
    return *this;
  }
  Type & set__auxservoactualtorque(
    const double & _arg)
  {
    this->auxservoactualtorque = _arg;
    return *this;
  }
  Type & set__extpioinput(
    const std::array<uint16_t, 8> & _arg)
  {
    this->extpioinput = _arg;
    return *this;
  }
  Type & set__extpiooutput(
    const std::array<uint16_t, 8> & _arg)
  {
    this->extpiooutput = _arg;
    return *this;
  }
  Type & set__extadcinput(
    const std::array<uint16_t, 4> & _arg)
  {
    this->extadcinput = _arg;
    return *this;
  }
  Type & set__extadcoutput(
    const std::array<uint16_t, 4> & _arg)
  {
    this->extadcoutput = _arg;
    return *this;
  }
  Type & set__reconnect_flag(
    const uint8_t & _arg)
  {
    this->reconnect_flag = _arg;
    return *this;
  }
  Type & set__exaxiscoordid(
    const uint8_t & _arg)
  {
    this->exaxiscoordid = _arg;
    return *this;
  }
  Type & set__slave_status_1(
    const double & _arg)
  {
    this->slave_status_1 = _arg;
    return *this;
  }
  Type & set__slave_status_2(
    const double & _arg)
  {
    this->slave_status_2 = _arg;
    return *this;
  }
  Type & set__slave_domain_id(
    const int32_t & _arg)
  {
    this->slave_domain_id = _arg;
    return *this;
  }
  Type & set__program_run_state(
    const uint8_t & _arg)
  {
    this->program_run_state = _arg;
    return *this;
  }
  Type & set__speed_scale_manual(
    const double & _arg)
  {
    this->speed_scale_manual = _arg;
    return *this;
  }
  Type & set__speed_scale_auto(
    const double & _arg)
  {
    this->speed_scale_auto = _arg;
    return *this;
  }
  ...
  bool operator==(const RobotNonrtState_ & other) const
  {
    ...
    if (this->exaxistatus1 != other.exaxistatus1) {
      return false;
    }
    if (this->exaxispos2 != other.exaxispos2) {
      return false;
    }
    if (this->exaxistatus2 != other.exaxistatus2) {
      return false;
    }
    if (this->exaxispos3 != other.exaxispos3) {
      return false;
    }
    if (this->exaxistatus3 != other.exaxistatus3) {
      return false;
    }
    if (this->exaxispos4 != other.exaxispos4) {
      return false;
    }
    if (this->exaxistatus4 != other.exaxistatus4) {
      return false;
    }
    ...
    if (this->auxservoservoid != other.auxservoservoid) {
      return false;
    }
    if (this->auxservoerrcode != other.auxservoerrcode) {
      return false;
    }
    if (this->auxservostate != other.auxservostate) {
      return false;
    }
    if (this->auxservoactualpos != other.auxservoactualpos) {
      return false;
    }
    if (this->auxservoctualspeed != other.auxservoctualspeed) {
      return false;
    }
    if (this->auxservoactualtorque != other.auxservoactualtorque) {
      return false;
    }
    if (this->extpioinput != other.extpioinput) {
      return false;
    }
    if (this->extpiooutput != other.extpiooutput) {
      return false;
    }
    if (this->extadcinput != other.extadcinput) {
      return false;
    }
    if (this->extadcoutput != other.extadcoutput) {
      return false;
    }
    if (this->reconnect_flag != other.reconnect_flag) {
      return false;
    }
    if (this->exaxiscoordid != other.exaxiscoordid) {
      return false;
    }
    if (this->slave_status_1 != other.slave_status_1) {
      return false;
    }
    if (this->slave_status_2 != other.slave_status_2) {
      return false;
    }
    if (this->slave_domain_id != other.slave_domain_id) {
      return false;
    }
    if (this->program_run_state != other.program_run_state) {
      return false;
    }
    if (this->speed_scale_manual != other.speed_scale_manual) {
      return false;
    }
    if (this->speed_scale_auto != other.speed_scale_auto) {
      return false;
    }
    return true;
  }
