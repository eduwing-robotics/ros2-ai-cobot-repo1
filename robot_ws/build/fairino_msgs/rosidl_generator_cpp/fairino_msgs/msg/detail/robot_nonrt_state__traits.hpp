  ...
  std::ostream & out)
{
  ...
  // member: exaxistatus1
  {
    if (msg.exaxistatus1.size() == 0) {
      out << "exaxistatus1: []";
    } else {
      out << "exaxistatus1: [";
      size_t pending_items = msg.exaxistatus1.size();
      for (auto item : msg.exaxistatus1) {
  ...
  // member: exaxistatus2
  {
    if (msg.exaxistatus2.size() == 0) {
      out << "exaxistatus2: []";
    } else {
      out << "exaxistatus2: [";
      size_t pending_items = msg.exaxistatus2.size();
      for (auto item : msg.exaxistatus2) {
        rosidl_generator_traits::value_to_yaml(item, out);
        if (--pending_items > 0) {
          out << ", ";
        }
  ...
  // member: exaxistatus3
  {
    if (msg.exaxistatus3.size() == 0) {
      out << "exaxistatus3: []";
    } else {
      out << "exaxistatus3: [";
      size_t pending_items = msg.exaxistatus3.size();
      for (auto item : msg.exaxistatus3) {
        rosidl_generator_traits::value_to_yaml(item, out);
        if (--pending_items > 0) {
          out << ", ";
        }
  ...
  // member: exaxistatus4
  {
    if (msg.exaxistatus4.size() == 0) {
      out << "exaxistatus4: []";
    } else {
      out << "exaxistatus4: [";
      size_t pending_items = msg.exaxistatus4.size();
      for (auto item : msg.exaxistatus4) {
        rosidl_generator_traits::value_to_yaml(item, out);
        if (--pending_items > 0) {
          out << ", ";
        }
  ...
  {
    out << "auxservoservoid: ";
    rosidl_generator_traits::value_to_yaml(msg.auxservoservoid, out);
    out << ", ";
  }
  ...
  {
    out << "auxservoerrcode: ";
    rosidl_generator_traits::value_to_yaml(msg.auxservoerrcode, out);
    out << ", ";
  }
  ...
  {
    out << "auxservostate: ";
    rosidl_generator_traits::value_to_yaml(msg.auxservostate, out);
    out << ", ";
  }

  // member: auxservoactualpos
  {
    out << "auxservoactualpos: ";
    rosidl_generator_traits::value_to_yaml(msg.auxservoactualpos, out);
    out << ", ";
  }

  // member: auxservoctualspeed
  {
    out << "auxservoctualspeed: ";
    rosidl_generator_traits::value_to_yaml(msg.auxservoctualspeed, out);
    out << ", ";
  }

  // member: auxservoactualtorque
  {
    out << "auxservoactualtorque: ";
    rosidl_generator_traits::value_to_yaml(msg.auxservoactualtorque, out);
    out << ", ";
  }

  // member: extpioinput
  {
    if (msg.extpioinput.size() == 0) {
      out << "extpioinput: []";
    } else {
      out << "extpioinput: [";
      size_t pending_items = msg.extpioinput.size();
      for (auto item : msg.extpioinput) {
        rosidl_generator_traits::value_to_yaml(item, out);
        if (--pending_items > 0) {
          out << ", ";
        }
  ...
  // member: extpiooutput
  {
    if (msg.extpiooutput.size() == 0) {
      out << "extpiooutput: []";
    } else {
      out << "extpiooutput: [";
      size_t pending_items = msg.extpiooutput.size();
      for (auto item : msg.extpiooutput) {
        rosidl_generator_traits::value_to_yaml(item, out);
        if (--pending_items > 0) {
          out << ", ";
        }
  ...
  // member: extadcinput
  {
    if (msg.extadcinput.size() == 0) {
      out << "extadcinput: []";
    } else {
      out << "extadcinput: [";
      size_t pending_items = msg.extadcinput.size();
      for (auto item : msg.extadcinput) {
        rosidl_generator_traits::value_to_yaml(item, out);
        if (--pending_items > 0) {
          out << ", ";
        }
  ...
  // member: extadcoutput
  {
    if (msg.extadcoutput.size() == 0) {
      out << "extadcoutput: []";
    } else {
      out << "extadcoutput: [";
      size_t pending_items = msg.extadcoutput.size();
      for (auto item : msg.extadcoutput) {
        rosidl_generator_traits::value_to_yaml(item, out);
        if (--pending_items > 0) {
          out << ", ";
        }
  ...
  {
    out << "reconnect_flag: ";
    rosidl_generator_traits::value_to_yaml(msg.reconnect_flag, out);
    out << ", ";
  }
  ...
  {
    out << "exaxiscoordid: ";
    rosidl_generator_traits::value_to_yaml(msg.exaxiscoordid, out);
    out << ", ";
  }
  ...
  {
    out << "slave_status_1: ";
    rosidl_generator_traits::value_to_yaml(msg.slave_status_1, out);
    out << ", ";
  }
  ...
  {
    out << "slave_status_2: ";
    rosidl_generator_traits::value_to_yaml(msg.slave_status_2, out);
    out << ", ";
  }
  ...
  {
    out << "slave_domain_id: ";
    rosidl_generator_traits::value_to_yaml(msg.slave_domain_id, out);
    out << ", ";
  }

  // member: program_run_state
  {
    out << "program_run_state: ";
    rosidl_generator_traits::value_to_yaml(msg.program_run_state, out);
    out << ", ";
  }

  // member: speed_scale_manual
  {
    out << "speed_scale_manual: ";
    rosidl_generator_traits::value_to_yaml(msg.speed_scale_manual, out);
    out << ", ";
  }

  // member: speed_scale_auto
  {
    out << "speed_scale_auto: ";
    rosidl_generator_traits::value_to_yaml(msg.speed_scale_auto, out);
  }
  out << "}";
