...
class Init_RemoteCmdInterface_Event_response
{
public:
  explicit Init_RemoteCmdInterface_Event_response(::fairino_msgs::srv::RemoteCmdInterface_Event & msg)
  : msg_(msg)
  {}
  ::fairino_msgs::srv::RemoteCmdInterface_Event response(::fairino_msgs::srv::RemoteCmdInterface_Event::_response_type arg)
  {
...
private:
  ::fairino_msgs::srv::RemoteCmdInterface_Event msg_;
};

class Init_RemoteCmdInterface_Event_request
{
public:
  explicit Init_RemoteCmdInterface_Event_request(::fairino_msgs::srv::RemoteCmdInterface_Event & msg)
  : msg_(msg)
  {}
  Init_RemoteCmdInterface_Event_response request(::fairino_msgs::srv::RemoteCmdInterface_Event::_request_type arg)
  {
    msg_.request = std::move(arg);
    return Init_RemoteCmdInterface_Event_response(msg_);
  }
...
class Init_RemoteCmdInterface_Event_info
{
public:
  Init_RemoteCmdInterface_Event_info()
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  Init_RemoteCmdInterface_Event_request info(::fairino_msgs::srv::RemoteCmdInterface_Event::_info_type arg)
  {
    msg_.info = std::move(arg);
    return Init_RemoteCmdInterface_Event_request(msg_);
  }
...
template<>
inline
auto build<::fairino_msgs::srv::RemoteCmdInterface_Event>()
{
  return fairino_msgs::srv::builder::Init_RemoteCmdInterface_Event_info();
}
