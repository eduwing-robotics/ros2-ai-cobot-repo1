...
#include "vision_interfaces/msg/detail/detections__rosidl_typesupport_fastrtps_c.h"
...
#include "rosidl_runtime_c/string.h"  // camera
#include "rosidl_runtime_c/string_functions.h"  // camera
#include "std_msgs/msg/detail/header__functions.h"  // header
#include "vision_interfaces/msg/detail/part__functions.h"  // parts
...
using _Detections__ros_msg_type = vision_interfaces__msg__Detections;


ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_vision_interfaces
bool cdr_serialize_vision_interfaces__msg__Detections(
  const vision_interfaces__msg__Detections * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: header
  {
  ...
  // Field name: parts
  {
    ...
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_vision_interfaces__msg__Part(
        &array_ptr[i], cdr);
    }
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_vision_interfaces
bool cdr_deserialize_vision_interfaces__msg__Detections(
  eprosima::fastcdr::Cdr & cdr,
  vision_interfaces__msg__Detections * ros_message)
{
  // Field name: header
  {
  ...
  // Field name: parts
  {
    ...
    if (ros_message->parts.data) {
      vision_interfaces__msg__Part__Sequence__fini(&ros_message->parts);
    }
    ...
    auto array_ptr = ros_message->parts.data;
    for (size_t i = 0; i < size; ++i) {
      cdr_deserialize_vision_interfaces__msg__Part(cdr, &array_ptr[i]);
    }
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_vision_interfaces
size_t get_serialized_size_vision_interfaces__msg__Detections(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  ...
  // Field name: parts
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_vision_interfaces__msg__Part(
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_vision_interfaces
size_t max_serialized_size_vision_interfaces__msg__Detections(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // Field name: parts
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_vision_interfaces__msg__Part(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = vision_interfaces__msg__Detections;
    is_plain =
      (
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_vision_interfaces
bool cdr_serialize_key_vision_interfaces__msg__Detections(
  const vision_interfaces__msg__Detections * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: header
  ...
  // Field name: parts
  {
    ...
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_key_vision_interfaces__msg__Part(
        &array_ptr[i], cdr);
    }
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_vision_interfaces
size_t get_serialized_size_key_vision_interfaces__msg__Detections(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Detections__ros_msg_type * ros_message = static_cast<const _Detections__ros_msg_type *>(untyped_ros_message);
  ...
  // Field name: parts
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_key_vision_interfaces__msg__Part(
        &array_ptr[index], current_alignment);
    }
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_vision_interfaces
size_t max_serialized_size_key_vision_interfaces__msg__Detections(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // Field name: parts
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_key_vision_interfaces__msg__Part(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const vision_interfaces__msg__Detections * ros_message = static_cast<const vision_interfaces__msg__Detections *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_vision_interfaces__msg__Detections(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  vision_interfaces__msg__Detections * ros_message = static_cast<vision_interfaces__msg__Detections *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_vision_interfaces__msg__Detections(cdr, ros_message);
}

static uint32_t _Detections__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_vision_interfaces__msg__Detections(
...
static size_t _Detections__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_vision_interfaces__msg__Detections(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, vision_interfaces, msg, Detections)() {
