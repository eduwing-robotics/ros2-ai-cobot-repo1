...
#include "vision_interfaces/msg/detail/inspection__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const vision_interfaces::msg::Inspection & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Member: slot_ids
  {
    cdr << ros_message.slot_ids;
  }

  // Member: slot_status
  {
    cdr << ros_message.slot_status;
  }
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  vision_interfaces::msg::Inspection & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  // Member: expected
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    size_t item_size = sizeof(ros_message.expected[0]);
  ...
  // Member: found
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    size_t item_size = sizeof(ros_message.found[0]);
    current_alignment += array_size * item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  ...
  // Member: slot_ids
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += padding +
        eprosima::fastcdr::Cdr::alignment(current_alignment, padding) +
        (ros_message.slot_ids[index].size() + 1);
    }
  }
  ...
  // Member: slot_status
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += padding +
        eprosima::fastcdr::Cdr::alignment(current_alignment, padding) +
        (ros_message.slot_status[index].size() + 1);
    }
  }
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_vision_interfaces
max_serialized_size_Inspection(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = vision_interfaces::msg::Inspection;
    is_plain =
      (
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_vision_interfaces
max_serialized_size_key_Inspection(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
{
  auto typed_message =
    static_cast<const vision_interfaces::msg::Inspection *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<vision_interfaces::msg::Inspection *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _Inspection__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const vision_interfaces::msg::Inspection *>(
...
static size_t _Inspection__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_Inspection(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _Inspection__callbacks = {
...
static rosidl_message_type_support_t _Inspection__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_Inspection__callbacks,
...
{
  return &vision_interfaces::msg::typesupport_fastrtps_cpp::_Inspection__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, vision_interfaces, msg, Inspection)() {
  return &vision_interfaces::msg::typesupport_fastrtps_cpp::_Inspection__handle;
}
