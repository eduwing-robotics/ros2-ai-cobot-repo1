...
#include "vision_interfaces/msg/detail/detections__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const vision_interfaces::msg::Part &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
...
cdr_serialize(
  const vision_interfaces::msg::Detections & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  vision_interfaces::msg::Detections & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  // Member: parts
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        vision_interfaces::msg::typesupport_fastrtps_cpp::max_serialized_size_Part(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = vision_interfaces::msg::Detections;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Member: parts
  {
    ...
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; i++) {
      vision_interfaces::msg::typesupport_fastrtps_cpp::cdr_serialize_key(
        ros_message.parts[i],
        cdr);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Member: parts
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        vision_interfaces::msg::typesupport_fastrtps_cpp::get_serialized_size_key(
        ros_message.parts[index], current_alignment);
    }
  }
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_vision_interfaces
max_serialized_size_key_Detections(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // Member: parts
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        vision_interfaces::msg::typesupport_fastrtps_cpp::max_serialized_size_key_Part(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
...
{
  auto typed_message =
    static_cast<const vision_interfaces::msg::Detections *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<vision_interfaces::msg::Detections *>(
    untyped_ros_message);
...
{
  return &vision_interfaces::msg::typesupport_fastrtps_cpp::_Detections__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, vision_interfaces, msg, Detections)() {
  return &vision_interfaces::msg::typesupport_fastrtps_cpp::_Detections__handle;
}
