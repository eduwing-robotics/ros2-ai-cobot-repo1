...
- [8. 로봇 작업공간 구성](#8-로봇-작업공간-구성)
- [9. 하드웨어 모델링 및 제작](#9-하드웨어-모델링-및-제작)
- [10. 공정 상태 다이어그램](#10-공정-상태-다이어그램)
- [11. 시퀀스 다이어그램](#11-시퀀스-다이어그램)
- [12. 핵심 기술과 문제 해결](#12-핵심-기술과-문제-해결)
...
| 8. 작업공간 | 구역 표시 사진 등록 완료 | 트레이·FR5·그리퍼/D435·컨베이어·검사 구역·조립 구역 |
| 9. 하드웨어 모델링 | 모델링·제작 사진 6장 등록 완료 | 기판·브래킷·핑거·트레이·컨베이어 |
