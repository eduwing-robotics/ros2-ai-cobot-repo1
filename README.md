...
- [12. 구현 결과와 검증](#12-구현-결과와-검증)
- [13. 현재 한계와 확장 목표](#13-현재-한계와-확장-목표)
- [14. 프로젝트 타임라인](#14-프로젝트-타임라인)
- [15. 소스 구성](#15-소스-구성)
- [16. 프로젝트 기술 스택](#16-프로젝트-기술-스택)
- [17. 설치와 실행](#17-설치와-실행)
- [18. 로컬 준비 항목과 문서 출처](#18-로컬-준비-항목과-문서-출처)
...
**불량대책서는 검사 후 검사 결과를 바탕으로 자동 생성됩니다.** 아래는 자동 생성되는 불량대책서의 예시입니다.
...
| 16. 검증·문서화 | 실물 작업 기록, 소프트웨어 회귀 점검과 main 통합 |
...
| 12. 구현 결과 | 검사 결과 사진 등록 완료 | 원본·히트맵·오버레이와 불량대책서 예시 |
| 11. 핵심 기술 | 이미지 등록 완료 | 트레이 부품 검출 결과 |
| 11. 핵심 기술 | 이미지 3장 등록 완료 | IND·VRM·SMD 보완 사례 |
| 12. 구현 결과 | 반복 검사 사례 이미지 등록 완료 | 정상 기판 검사 결과 |
