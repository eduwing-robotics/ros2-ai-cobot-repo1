...
<table width="100%">
  <tr><th width="50%">그리퍼 · D435 장착부</th><th width="50%">부품 · 트레이</th></tr>
  <tr><td align="center"><br>제작 핑거 · 아래를 향한 Eye-in-Hand 카메라<br><br><em>사진 추가 예정</em><br><br></td><td align="center"><br>6종 부품과 전용 트레이 · 제작 기판<br><br><em>사진 추가 예정</em><br><br></td></tr>
</table>
...
| 7. 하드웨어 | `assets/images/parts-tray.png` | 6종 25개 부품·트레이·기판 |
