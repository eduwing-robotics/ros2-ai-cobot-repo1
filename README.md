...
<p align="center">
  <img src="https://github.com/user-attachments/assets/ec7332ae-3d75-47c6-8119-c7687a8be210" alt="KSMC 로봇 작업공간 구성" width="100%" />
</p>
...
- **05 · 패키지 기판** — 여러 종류의 모형 부품을 정해진 위치에 조립하는 작업 대상입니다.
- **06 · 제어 PC** — 로봇·비전 제어 프로그램을 실행하고 작업 상태를 확인합니다.
- **07 · 조립 구역** — 사진 앞쪽 첫 번째 기판이 놓인 위치입니다. 컨베이어를 정지한 뒤 기판의 위치·자세를 인식하고, FR5가 트레이의 부품을 집어 정밀 배치·조립합니다.
...
| 4. 작업공간 | 구역 표시 사진 등록 완료 | 트레이·FR5·그리퍼/D435·컨베이어·기판·제어 PC·조립 구역 |
