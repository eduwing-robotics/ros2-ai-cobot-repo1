...
```text
~/KSMC/calibration/data/handeye_multipose_validation.csv
```
...
~/KSMC/calibration/run_handeye_multipose_validation.sh \
  --marker-id 11 \
  --frames 20 \
  --csv ~/KSMC/calibration/data/handeye_multipose_marker11.csv
```
...
~/KSMC/calibration/run_handeye_multipose_validation.sh \
  ...
  --frames 20 \
  --pnp-method ippe \
  --csv ~/KSMC/calibration/data/handeye_ry_repeatability_ippe.csv
```
