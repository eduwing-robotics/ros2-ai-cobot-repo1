...
root=Path('/home/juchan-yoon/FR5_robot_control');manual_path=root/'vision_assembly/data/smd45_manual_axes_20260906.json';manual=json.loads(manual_path.read_text())
assert manual['mode']=='operator_two_terminal_axes' and manual['operator_confirmed_consumed_prefix_count']==3
