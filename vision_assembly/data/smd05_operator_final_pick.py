...
record=dict(part='SMD-05',status='checking',operator_alignment_report='operator clicked both current SMD05 terminal centers; fixture height exercised by SMD01-04',physical_alignment_independently_verified=False,physical_grasp_verified=False,part_held_candidate=False,recipe_sha256=hashlib.sha256(recipe_path.read_bytes()).hexdigest(),started_unix=time.time(),stages=[])
