...
- 통합 저장소 안내: [프로젝트 개요](../README.md)
- PC별 실행·Endpoint 소유권: [통합 운영 안내](../docs/integration/OPERATIONS.md)
- MainServer 공개 API: [Main_serverAPI.md](MAIN_SERVER/Main_serverAPI.md)
